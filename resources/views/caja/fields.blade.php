 ...
 <div class="col-sm-12 col-md-6">
    ...
    <div class="form-group col-sm-6" id="div-name">
        ...
        {!! Form::select('tipo_movimiento_id', $tiposMovimientos, isset($movimientos)? $movimientos->tipo_movimiento_id : 'null', ['class' => 'form-control','autofocus'=>'autofocus', 'placeholder' => 'Seleccione una opci&oacute;n..']) !!}
    </div>

    <div class="form-group col-sm-6" id="div-name">
        {!! Form::label('payment_type_id', 'Tipo Movimiento: *',['class' => 'control-label mb-10 text-left']) !!}
        {!! Form::select('payment_type_id', $tiposPagos, isset($movimientos)? $movimientos->payment_type_id : 'null', ['class' => 'form-control','autofocus'=>'autofocus', 'placeholder' => 'Seleccione una opci&oacute;n..']) !!}
    </div>
